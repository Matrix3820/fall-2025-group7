...
data_version = "TrialLevelExperiment"
model_version = "V1"
...
class XGBoostClassifier:
    ...
    def prepare_features(self, df):
        exclude_columns = ['sub', 'profile', 'FSR', 'FSR_scaled', 'free_response', 'td_or_asd','mean_slope_overall_subcat','mean_slope_overall_cat', 'mean_slope_subcat', 'mean_slope_cat','trial']
