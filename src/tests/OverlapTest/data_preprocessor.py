...
def preprocess_training_data():
    ...
    # Assume df has at least columns: 'FSR' and 'class'
    # Replace 'class' with your actual label column if different
    ...
    # Step 2: separate test (overlap) and train (non-overlap)
