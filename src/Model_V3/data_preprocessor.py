...
def preprocess_training_data():
    ...
    artifacts_dir = project_root / "Results" / "V2Q" / "preprocessing"
    ...
    train_path = project_root / "data" / "Data_v2q" / "LLM_data_train_v2q.csv"
    test_path = project_root / "data" / "Data_v2q" / "LLM_data_test_v2q.csv"
    ...
    train_output_path = project_root / "data" / "Data_v2q" / "LLM_data_train_preprocessed_v2q.csv"
    test_output_path = project_root / "data" / "Data_v2q" / "LLM_data_test_preprocessed_v2q.csv"
...
class CharacteristicFeatureExtractor:
    def __init__(self, batch_size=10):
        ...
        log_dir = project_root / "Results" / "V2Q" / "logs"
        ...
        char_path = project_root / "data" / "Data_v2q" / "charactristic.txt"
...
def preprocess_prediction_data(df, is_test_data=False):
    ...
    if is_test_data:
        test_preprocessed_path = project_root / "data" / "Data_v2q" / "LLM_data_test_preprocessed_v2q.csv"
