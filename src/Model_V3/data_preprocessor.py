...
def preprocess_training_data():
    ...
    train_path = project_root / "data" / data_version / "LLM_data_train_v3.csv"
    test_path = project_root / "data" / data_version / "LLM_data_test_v3.csv"
    ...
    train_output_path = project_root / "data" / data_version / "LLM_data_train_preprocessed_v3.csv"
    test_output_path = project_root / "data" / data_version / "LLM_data_test_preprocessed_v3.csv"
...
def preprocess_prediction_data(df, is_test_data=False):
    ...
    if is_test_data:
        test_preprocessed_path = project_root / "data" / data_version/ "LLM_data_test_preprocessed_v3.csv"
