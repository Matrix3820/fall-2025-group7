...
class ModelVisualizer:
    def __init__(self):
        ...
        self.results_dir = project_root / "Results" / "V2Q"
    ...
    def load_results(self):
        explainability_path = self.results_dir / 'explainability_analysis_v2q.json'
        training_results_path = self.results_dir / 'training_results_v2q.json'
    ...
    def create_feature_importance_plot(self, explainability_data):
        ...
        plt.title('Top 20 Most Important Features - XGBoost Model V2Q')
        ...
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'feature_importance_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def create_characteristic_importance_plot(self, explainability_data):
        ...
        ax1.set_title('Characteristic Importance Scores - Model V2Q')
        ...
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'characteristic_importance_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def create_td_vs_asd_comparison_plot(self, explainability_data):
        ...
        train_data_path = self.results_dir.parent.parent / "data" / "Data_v2q" / "LLM_data_train_preprocessed_v2q.csv"
        ...
        ax.set_title('TD vs ASD: Characteristic Mention Patterns - Model V2Q')
        ax.set_xticks(x)
        ...
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'td_vs_asd_comparison_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def create_model_performance_plot(self, training_results):
        ...
        ax1.set_title('Cross-Validation Scores - Model V2Q')
        ...
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'model_performance_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
    
    def create_confusion_matrix_plot(self, test_results_path=None):
        if test_results_path is None:
            test_results_path = self.results_dir / 'test_results_v2q.json'
        ...
        plt.title('Confusion Matrix - Model V2Q')
        plt.xlabel('Predicted')
        plt.ylabel('Actual')
        
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'confusion_matrix_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def create_feature_importance_by_target_plot(self, explainability_data):
        ...
        ax1.set_title('Top Features: Importance and Target Class Comparison - Model V2Q')
        ax1.set_xticks(x)
        ...
        plt.tight_layout()
        plt.savefig(self.viz_dir / 'feature_importance_by_target_v2q.png', dpi=300, bbox_inches='tight')
        plt.close()
        
        print(f"Feature importance by target plot saved to: {self.viz_dir / 'feature_importance_by_target_v2q.png'}")
