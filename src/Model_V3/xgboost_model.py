...
class XGBoostClassifier:
    ...
    def load_model(self, model_dir=None):
        ...
        fi_path = model_dir / f"feature_importance_{model_version}.json"
        if fi_path.exists():
...
def train_xgboost_model():
    ...
    print("\nTraining completed!")
    print(f"CV accuracy: {training_results['cv_accuracy_mean']:.4f} (+/- {training_results['cv_accuracy_std']:.4f})")
