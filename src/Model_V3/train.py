...
def run_complete_training_pipeline():
    print("=" * 60)
    print("STARTING MODEL V2-QWEN TRAINING PIPELINE")
    print("=" * 60)
    ...
    try:
        ...
        train_preprocessed_path = os.path.join('..', '..', 'data', 'Data_v2q', 'LLM_data_train_preprocessed_v2q.csv')
        test_preprocessed_path = os.path.join('..', '..', 'data', 'Data_v2q', 'LLM_data_test_preprocessed_v2q.csv')
        ...
        print(f"\nModel saved to: ANN-Modeling/Results/V2Q/")
