...
def run_complete_training_pipeline():
    print("=" * 60)
    print(f"STARTING {model_version} TRAINING PIPELINE")
    print("=" * 60)
    ...
    try:
        ...
        train_preprocessed_path = os.path.join('..', '..', 'data', data_version, 'LLM_data_train_preprocessed_v3.csv')
        test_preprocessed_path = os.path.join('..', '..', 'data', data_version, 'LLM_data_test_preprocessed_v3.csv')
