...
class ModelVisualizer:
    ...
    def create_feature_importance_plot(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(plt.gcf(), self.viz_dir / 'feature_importance_v2')
        plt.close()
    ...
    def create_characteristic_importance_plot(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'characteristic_importance_v2')
        plt.close()
    ...
    def create_td_vs_asd_comparison_plot(self, explainability_data):
        ...
        # Add FSR and PE from preprocessed training data
        train_data_path = self.results_dir.parent.parent / "data" / "Data_v2" / "LLM_data_train_preprocessed_v2.csv"
        if train_data_path.exists():
            ...
            # Normalize
            fsr_min, fsr_max = train_df['FSR'].min(), train_df['FSR'].max()
            ...
            pe_min, pe_max = train_df['avg_PE'].min(), train_df['avg_PE'].max()
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'td_vs_asd_comparison_v2')
        plt.close()
    ...
    def create_model_performance_plot(self, training_results):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'model_performance_v2')
        plt.close()
    ...
    def create_confusion_matrix_plot(self, test_results_path=None):
        ...
        plt.tight_layout()
        save_figure_multi_formats(plt.gcf(), self.viz_dir / 'confusion_matrix_v2')
        plt.close()
    ...
    def create_feature_importance_by_target_plot(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'feature_importance_by_target_v2')
        plt.close()
