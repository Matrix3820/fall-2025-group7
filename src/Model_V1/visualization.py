...
class ModelVisualizer:
    ...
    def create_feature_importance_plot(self, training_results):
        ...
        plt.tight_layout()
        save_figure_multi_formats(plt.gcf(), self.viz_dir / 'feature_importance_v1')
        plt.close()
    ...
    def create_characteristic_importance_stacked_bar(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'characteristic_importance_v1')
        plt.close()
    ...
    def create_td_vs_asd_comparison_plot(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'td_vs_asd_comparison_v1')
        plt.close()
    ...
    def create_model_performance_plot(self, training_results):
        if 'classification_report' in training_results:
            ...
            plt.tight_layout()
            save_figure_multi_formats(fig, self.viz_dir / 'model_performance_v1')
            plt.close()
        else:
            cv_mean = training_results.get('cv_mean', 0)
            cv_std = training_results.get('cv_std', 0)
            ...
            if cv_scores:
                ...
                ax.text(
                    0.02,
                    0.98,
                    f'CV Mean: {cv_mean:.3f} ± {cv_std:.3f}',
    ...
    def create_confusion_matrix_plot(self, training_results):
        if 'confusion_matrix' in training_results:
            ...
            plt.tight_layout()
            save_figure_multi_formats(plt.gcf(), self.viz_dir / 'confusion_matrix_v1')
            plt.close()
        else:
    ...
    def create_characteristic_ranking_plot(self, explainability_data):
        ...
        plt.tight_layout()
        save_figure_multi_formats(fig, self.viz_dir / 'characteristic_ranking_v1')
        plt.close()
